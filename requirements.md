...
1. **Users can subscribe to multiple interests**  
...
2. **User-defined filtering criteria**  
...
4. **Closed set of developer-defined interests**  
...
6. **Connection requests and chat**  
...
7. **Availability Status (Open to meetup/Busy)**  
...
6. **Connection requests and chats**  
...
1. **Multiple Interest Subscriptions & Filtering**  
...
7. **Availability Status: ? Open to Meet : Busy**  
...
8. **Streaks & Leaderboard**  
   ...
   * **Exceptional Flow:** User A and User B go 8 days without exchanging a message. The streak resets to 0\. Both users receive a notification: \&quot;Your streak with \[name\] has ended. Start a new one by sending a message\!\&quot; The leaderboard updates to reflect the reset.  
